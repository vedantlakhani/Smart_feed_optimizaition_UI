...
- [x] **CHEM-02**: Chemistry details use progressive disclosure: plain language summary always visible, formula expandable, derivation expandable — so both professors and operators are served
...
| CHEM-02 | Phase 4: Chemistry Validation | Complete |
